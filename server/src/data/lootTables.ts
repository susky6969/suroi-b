    ...
    tango_crate: {
        ...
        loot: [
            ...
            [
                ...
                { item: "tango_51", spawnSeparately: true, count: 7, weight: 30.0000001 }
            ]
        ]
    },
    lux_crate: {
...
export const LootTiers: Record<string, readonly WeightedItem[]> = {
    guns: [
        ...
        { item: "m1895", weight: 0.05 },
        { item: "mp40", weight: 0.07 },
        { item: "saf_200", weight: 0.05 },
        { item: "cz75a", weight: 0.05 },
        { item: "hp18", weight: 0.025 },
        { item: "micro_uzi", weight: 0.009 },
        { item: "ak47", weight: 0.025 },
        ...
        { item: "firework_launcher", weight: 0.5 }, // birthday mode
        { item: "vector", weight: 0.4 },
        { item: "negev", weight: 0.3 },
        { item: "mg5", weight: 0.3 },
        { item: "tango_51", weight: 0.6 }
    ],
    healing_items: [
    ...
    equipment: [
        ...
        { item: "tactical_helmet", weight: 0 },

        { item: "basic_vest", weight: 1 },
        { item: "regular_vest", weight: 0.2 },
        { item: "tactical_vest", weight: 0 },

        { item: "basic_pack", weight: 1 },
        { item: "regular_pack", weight: 0.2 },
        { item: "tactical_pack", weight: 0 }
    ],
    ammo: [
    ...
    melee: [
        ...
        { item: "fists", weight: 2 },
        { item: "maul", weight: 3 },
        //{ item: "deathray", weight: 3},
        { item: "steelfang", weight: 2},
        //{ item: "heap_sword", weight: 3}
    ],
    airdrop_equipment: [
    ...
    gold_airdrop_guns: [
        ...
        //{ item: "arena_closer", weight: 0.5},
        { item: "usas12", weight: 1.5}
    ],
    winter_skins: [
