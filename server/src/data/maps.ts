...
const maps = {
    main: {
        ...
        obstacles: {
            ...
            river_rock: 10,
            bush: 40,
            birthday_cake: 40, // birthday mode
            lily_pad: 20,
            blueberry_bush: 30,
            barrel: 1,
            viking_chest: 25,
        ...
        places: [
            { name: "CTTN Kingdom", position: Vec.create(0.8, 0.7) },
            { name: "Cannot find module '../build/Release/canvas.node'", position: Vec.create(0.6, 0.8) },
            { name: "Centralia", position: Vec.create(0.7, 0.3) },
            { name: "cute catgirl Forest", position: Vec.create(0.3, 0.2) },
            { name: "RIGC Valley", position: Vec.create(0.3, 0.7) },
            { name: "ben is big", position: Vec.create(0.4, 0.5) }
        ]
    },
    debug: {
        width: 1620,
